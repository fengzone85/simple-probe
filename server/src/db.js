...
function getUiSettings() {
  const def = { site_title: '', custom_css: '', default_sort: 'created', group_order: [], agent_server_url: '', alert: { cpu_pct: 90, mem_pct: 90, offline_sec: 60 }, public_enabled: false, home_layout: 'grid', public_theme: 'default' };
  try {
